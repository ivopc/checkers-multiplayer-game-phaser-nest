...
import lightMask from "../../assets/common/overlay.png";
import winHighlight from "../../assets/common/win-light.webp"
...
export const WinBGContainer = styled.div`
  position: relative;
  width: 100%;
  height: 100vh;
  max-width: 945px;
...
export const WinBGImage = styled(CenteredIcon)`
  display: flex;
  justify-content: center;
  width: 100%;
  height: 100%;
...
export const WinValueContainer = styled(CenteredIcon)`
  position: absolute;
  display: flex;
  width: 350px;
  justify-content: center;
